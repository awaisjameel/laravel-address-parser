...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/awaisjameel/laravel-address-parser/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/awaisjameel/laravel-address-parser/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-address-parser.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-address-parser)
...
```bash
php artisan vendor:publish --tag="laravel-address-parser-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-address-parser-views"
```

## Usage

```php
$laravelAddressParser = new Awaisjameel\LaravelAddressParser();
echo $laravelAddressParser->echoPhrase('Hello, Awaisjameel!');
```
